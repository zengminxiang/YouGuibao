...
import com.zmx.youguibao.emoticon.adapter.HorizontalRecyclerviewAdapter;
import com.zmx.youguibao.emoticon.adapter.NoHorizontalScrollerVPAdapter;
import com.zmx.youguibao.emoticon.bean.ImageModel;
import com.zmx.youguibao.emoticon.boardview.EmotionKeyboard;
import com.zmx.youguibao.emoticon.boardview.NoHorizontalScrollerViewPager;
import com.zmx.youguibao.emoticon.utils.EmotionUtils;
import com.zmx.youguibao.emoticon.utils.GlobalOnItemClickManagerUtils;
...
public class EmotionMainFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mEmotionKeyboard = EmotionKeyboard.with(getActivity())
                ...
                .bindToSendButton(rootView.findViewById(R.id.bar_btn_send)).build();
    ...
    protected void initDatas(){
        ...
        //记录底部默认选中第一个
        CurrentPosition=0;
        SharePreferenceUtil.getInstance(mActivity).saveKeyObjValue(CURRENT_POSITION_FLAG,CurrentPosition);
        ...
        horizontalRecyclerviewAdapter.setOnClickItemListener(new HorizontalRecyclerviewAdapter.OnClickItemListener() {
            ...
            public void onItemClick(View view, int position, List<ImageModel> datas) {
                //获取先前被点击tab
                int oldPosition =  SharePreferenceUtil.getInstance(mActivity).getIntType(CURRENT_POSITION_FLAG, 0);
                //修改背景颜色的标记
    ...
    /**
     * 在评论详情里面用到,判断表情框是否隐藏了
     * @return
     */
    public boolean isViewShown(){

        return mEmotionKeyboard.isViewShown();
