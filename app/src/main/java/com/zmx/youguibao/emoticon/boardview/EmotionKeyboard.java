...
public class EmotionKeyboard {
    ...
    public EmotionKeyboard bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //通知更新
                ccl.onChatCommentLiseners(mEditText.getText().toString());
                Log.e("点击了", "发送按钮");
                mEditText.setText("");
            }
        });
    ...
    public boolean isViewShown(){
        ...
        Log.e("isSoftInputShown","是否"+isSoftInputShown());
    ...
    private int getSupportSoftInputHeight() {
        ...
        if (softInputHeight < 0) {
            Log.e("s", "EmotionKeyboard--Warning: value of softInputHeight is below zero!");
        }
        //存一份到本地
        if (softInputHeight > 0) {
    ...
    //聊天列表回调接口
    public static ChatCommentLiseners ccl;

    public void setChatCommentLiseners(ChatCommentLiseners ccl) {
        this.ccl = ccl;
    }

    public interface ChatCommentLiseners {
        void onChatCommentLiseners(String comment);//更新聊天列表
    }
