...
public class FollowFragment extends BaseFragment implements FollowFragmentView{
    ...
    protected void initView() {
        ...
        mPtrFrame.setPtrHandler(new PtrDefaultHandler() {
            ...
            public void onRefreshBegin(PtrFrameLayout frame) {
                ...
                page = 1;
                load_tag = 0;
                presenter.AllFollowVideo("queryFollow", page + "","1");
        ...
        mPtrFrame.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void loadMore() {
                ...
                if (page == pagenow) {
                    ...
                    Toast.makeText(FollowFragment.this.getActivity(), "没有更多数据", Toast.LENGTH_SHORT)
                            .show();
    ...
    @Override
    public void AllFollowVideo(List<VideoListJson> lists, String pagenow) {
